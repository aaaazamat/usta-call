...
UNFOLD = {
    ...
    "BORDER_RADIUS": "8px",
    # Frontend bilan bir xil ranglar: slate neytral + binafsha (violet) primary.
    # Asosiy sayt brendi ko'k→binafsha→pushti gradient (#8b5cf6 — asosiy binafsha).
    "COLORS": {
        "base": {
            "50": "248 250 252",
            "100": "241 245 249",
        ...
        # Tailwind violet — saytdagi binafsha brend rangi
        "primary": {
            "50": "245 243 255",
            "100": "237 233 254",
            "200": "221 214 254",
